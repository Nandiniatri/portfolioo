...
//             <div class="services-Main-Container-h1"><h1>CORE COMPETENCIES</h1></div>
//             <div class="services-Main1-Container">
//                 <div class="services-Main1-Container-innerDiv">
//                     <div class="services-Main1-Container-innerDiv-icon">
//                         <i class="fa fa-phone"></i>
//                     </div>
//                     <div>
//                         <h5>Web Design</h5>
...
export class Services {
    ...
    initScrollObserver() {
        const serviceItems = document.querySelectorAll('.services-Main1-Container-innerDiv');
